...
const About = ({ isDark }) => {
  ...
  const skills = [
    ...
    },
    {
      ...
      icon: "https://logo.svgcdn.com/devicon/tailwindcss-original.svg",
    },
    {
      name: "Bootstrap",
    ...
    },
    {
      ...
      icon: "https://logo.svgcdn.com/devicon/laravel-original.svg",
    },
    {
      name: "PHP",
  ...
  return (
    ...
    >
      {/* Background & Glow same as your code */}
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                {skills.map((skill, index) => (
                  <a
                    ...
                    className={`relative flex items-center gap-2 rounded-2xl p-4 transition-all duration-300 hover:scale-105 hover:-translate-y-1 border ${
                      isDark
